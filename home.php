...
<body>
<div id="mun_nodos">
<form method="get" name="formulario" action="home.php">
<label>Ingrese N° Aristas</label>
<input type="text" class="texto1" id="aristas"name="aristas"></br>
...
<div id="matriz">
<form method="post" name="for_mat" action="incidencia.php" enctype="multipart/form-data">
    <input type="hidden" name="vertices" value="<?php echo  $_GET['vertices'];?>">
    <input type="hidden" name="aristas" value="<?php echo $_GET['aristas'];?>">

<?php 
$nodos = $_GET['vertices'];
$aristas = $_GET['aristas'];
